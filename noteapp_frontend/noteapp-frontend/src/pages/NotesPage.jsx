...
export default function NotesPage() {
    ...
    return <Box mt={20} padding={8}>
        <Grid gap={10} margin={"auto"} w={"100%"} gridTemplateColumns="repeat(4, 1fr)">
            {notes?.map((e1) => <NoteCard {...e1} />)}
        </Grid>
        <IconButton boxShadow={"rgba(60, 64, 67, 0.3) 0px 1px 2px 0px , rgba(60, 64, 67, 0.15) 0px 2px 6px 2px"} 
        position={"fixed"} 
        w={"80px"} 
        h={"80px"} 
        borderRadius={50} 
        ...
        >
            ...
            <ModalContent>
                ...
                <ModalBody pb={6}>
                    ...
                    <Textarea mt={6} value={body}m placeholder="Please enter description" onChange={(e)=>setBody(e.target.value)}></Textarea>
                </ModalBody>
